...
¡Hola! Soy Juan Diego, desarrollador y administrador de sistemas apasionado por automatizar tareas, administrar servicios y construir herramientas útiles.

🚀 Resumen

- Experiencia en administración de sistemas Linux: scripting en Shell, automatización y mantenimiento.
- Conocimientos en redes y servicios (prácticas con DHCP, configuraciones de red).
- Desarrollo y mantenimiento en PHP y Ruby.
- Mentalidad orientada a resolver problemas reales y aprender rápido.
...
Oportunidades como desarrollador junior, administrador de sistemas o roles de soporte técnico. Me interesa trabajar en equipos donde pueda mejorar la automatización, el mantenimiento de servicios y crear herramientas internas.
